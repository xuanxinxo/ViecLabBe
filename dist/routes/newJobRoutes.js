...
router.post("/", (req, res, next) => {
    ...
    next();
}, upload_1.uploadSingle, upload_1.handleUploadError, newJobController_1.createNewJob);
router.put("/:id", (req, res, next) => {
    (0, cache_1.clearCache)('/api/newjobs');
    next();
}, upload_1.uploadSingle, upload_1.handleUploadError, newJobController_1.updateNewJob);
router.patch("/:id", (req, res, next) => {
    (0, cache_1.clearCache)('/api/newjobs');
    next();
}, upload_1.uploadSingle, upload_1.handleUploadError, newJobController_1.updateNewJob); // Add PATCH support for partial updates
